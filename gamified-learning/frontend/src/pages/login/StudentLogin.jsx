...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError(null);
    try {
      const data = await login({ email: form.email, password: form.password, role: 'student' });
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              ...
              <Link to="/signup/student" className="font-semibold text-emerald-300 hover:text-emerald-200">
                Sign up
              </Link>
            </motion.p>
          </form>
